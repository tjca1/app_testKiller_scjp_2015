 ...
 */
public final class GraficoUS extends JPanel
{
        ...
        {               
            ...
            data.setValue(VariaveisConstantes.R_ERRADAS_DISPLAY_GRAFICO_US, erradas);
            data.setValue(VariaveisConstantes.R_NAOFEITAS_DISPLAY_GRAFICO_US, n_feita);
            data.setValue(VariaveisConstantes.R_CORREATAS_DISPLAY_GRAFICO_US, certos);  
        }
