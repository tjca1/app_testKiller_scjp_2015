 ...
 */
public class q_38 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_38.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_38.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. itemID(int itemId)");

        jRadioButton_b.setText(" B. update(int itemId)");

        jRadioButton_c.setText("C. setItemId(int itemId)");
        ...
        jRadioButton_d.setText("D. mutateItemId(int itemId)");
        ...
        jRadioButton_e.setText("E. updateItemID(int itemId)");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                try
                {
                      internacionalizacao.determinaPropriedadeTextArea1("q_38.textPTA1");
    ...
    public ConteudoTextArea injetaInternacionalizacaoUSA()
    {
                try
                {
                      ...
                      internacionalizacao.determinaPropriedadeTextArea1("q_38.textENA1");
                      conteudo.setS_conteudoTextArea1(internacionalizacao.getConteudoTextArea1());
                      jTextArea1.setText(conteudo.getS_conteudoTextArea1());
