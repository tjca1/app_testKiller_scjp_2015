 ...
 */
public class q_210 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_210.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_210.status_classe = status_classe;
    }
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_210.class.getName()).log(Level.SEVERE, null, ex);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {
                    String nome;
                    nome =  q_210.class.getName().replaceAll(".java","");
                    nome =  q_210.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
