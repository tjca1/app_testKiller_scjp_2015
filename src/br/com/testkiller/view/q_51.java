 ...
 */
public class q_51 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_51.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_51.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. snootchy 420 third second first");

        jRadioButton_b.setText("B. snootchy 420 first second third");

        jRadioButton_c.setText("C. first second third snootchy 420");
        ...
        jRadioButton_d.setText("D. third second first siiootchy 420");
        ...
        jRadioButton_e.setText("E. third first second snootchy 420");
        ...
        jRadioButton_f.setText("F. first second first third snootchy 420");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_51.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                {
                    String nome;
                    nome =  q_51.class.getName().replaceAll(".java","");
                    nome =  q_51.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
