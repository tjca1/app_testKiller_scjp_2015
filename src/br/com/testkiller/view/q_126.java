 ...
 */
public class q_126 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_126.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_126.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 11, 609, 393);
        add(jRadioButton_a);
        jRadioButton_a.setBounds(0, 436, 535, 23);
        ...
        add(jRadioButton_b);
        jRadioButton_b.setBounds(0, 459, 535, 21);
        ...
        add(jRadioButton_c);
        jRadioButton_c.setBounds(0, 480, 535, 21);
        ...
        add(jRadioButton_d);
        jRadioButton_d.setBounds(0, 501, 535, 21);
        ...
        add(jButton1);
        jButton1.setBounds(20, 410, 108, 23);
        ...
        add(jLabel_status);
        jLabel_status.setBounds(0, 410, 15, 24);
        ...
        add(jRadioButton_e);
        jRadioButton_e.setBounds(0, 522, 535, 21);
        ...
        add(jRadioButton_f);
        jRadioButton_f.setBounds(0, 543, 535, 21);
        ...
        add(jRadioButton_g);
        jRadioButton_g.setBounds(0, 564, 535, 21);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_e.isSelected() &&  jRadioButton_g.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_126.class.getName()).log(Level.SEVERE, null, ex);
                ...
                {
                    String nome;
                    nome =  q_126.class.getName().replaceAll(".java","");
                    nome =  q_126.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
