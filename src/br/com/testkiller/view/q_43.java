 ...
 */
public class q_43 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_43.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_43.status_classe = status_classe;
    }
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    String nome;
                    nome =  q_43.class.getName().replaceAll(".java","");
                    nome =  q_43.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
                ...
                {
                    Logger.getLogger(q_43.class.getName()).log(Level.SEVERE, null, ex);
                }
                catch (IOException ex)
                {
                    Logger.getLogger(q_43.class.getName()).log(Level.SEVERE, null, ex);
