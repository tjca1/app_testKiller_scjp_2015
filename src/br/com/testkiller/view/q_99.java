 ...
 */
public class q_99 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_99.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_99.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jScrollPane4.setBounds(40, 240, 395, 100);
        ...
        jScrollPane2.setBounds(40, 130, 395, 100);
        ...
        jScrollPane3.setBounds(40, 20, 395, 100);
        ...
        jRadioButton_c.setBounds(500, 20, 20, 96);
        ...
        jRadioButton_d.setBounds(500, 140, 20, 80);
        ...
        jScrollPane6.setBounds(520, 130, 395, 100);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_b.isSelected() && jRadioButton_d.isSelected() && jRadioButton_e.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_99.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_99.class.getName().replaceAll(".java","");
                    nome =  q_99.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
