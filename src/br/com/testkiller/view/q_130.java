 ...
 */
public class q_130 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_130.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_130.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 1, 609, 450);
        add(jRadioButton_a);
        jRadioButton_a.setBounds(0, 490, 609, 23);
        ...
        add(jRadioButton_b);
        jRadioButton_b.setBounds(0, 510, 609, 21);
        ...
        add(jRadioButton_c);
        jRadioButton_c.setBounds(0, 530, 609, 21);
        ...
        add(jRadioButton_d);
        jRadioButton_d.setBounds(0, 550, 609, 21);
        ...
        add(jButton1);
        jButton1.setBounds(20, 450, 108, 23);
        ...
        add(jLabel_status);
        jLabel_status.setBounds(0, 450, 15, 30);
        ...
        add(jRadioButton_e);
        jRadioButton_e.setBounds(0, 570, 609, 21);
        ...
        add(jRadioButton_f);
        jRadioButton_f.setBounds(0, 590, 609, 21);
        add(auxF);
        auxF.setBounds(21, 469, 588, 15);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_a.isSelected() && jRadioButton_b.isSelected() && jRadioButton_e.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_130.class.getName()).log(Level.SEVERE, null, ex);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                private String NomeClasse()
                {
                    ...
                    String nome =  q_130.class.getName().replaceAll(".java","");
                    nome =  q_130.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
