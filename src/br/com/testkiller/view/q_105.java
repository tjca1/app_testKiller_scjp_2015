 ...
 */
public class q_105 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_105.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_105.status_classe = status_classe;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_f.isSelected() &&  jRadioButton_g.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_105.class.getName()).log(Level.SEVERE, null, ex);
                ...
                {
                    String nome;
                    nome =  q_105.class.getName().replaceAll(".java","");
                    nome =  q_105.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
