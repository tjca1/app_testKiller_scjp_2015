 ...
 */
public class q_41 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_41.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_41.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. public void foo() { }");

        jRadioButton_b.setText("B. public int foo() { return 3; }");

        jRadioButton_c.setText("C. public Two foo() { return this; }");
        ...
        jRadioButton_d.setText("D. public One foo() { return this; }");
        ...
        jRadioButton_e.setText("E. public Object foo() { return this; }");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_c.isSelected() == true && jRadioButton_d.isSelected() == true)
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    String nome;
                    nome =  q_41.class.getName().replaceAll(".java","");
                    nome =  q_41.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
                ...
                {
                    Logger.getLogger(q_41.class.getName()).log(Level.SEVERE, null, ex);
                }
                catch (IOException ex)
                {
                    Logger.getLogger(q_41.class.getName()).log(Level.SEVERE, null, ex);
