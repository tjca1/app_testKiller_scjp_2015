 ...
 */
public class q_137 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_137.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_137.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 0, 609, 340);
        add(jRadioButton_a);
        jRadioButton_a.setBounds(0, 372, 535, 23);
        add(jRadioButton_b);
        jRadioButton_b.setBounds(0, 395, 535, 21);
        ...
        add(jRadioButton_c);
        jRadioButton_c.setBounds(0, 416, 535, 21);
        ...
        add(jRadioButton_d);
        jRadioButton_d.setBounds(0, 437, 535, 21);
        ...
        add(jButton1);
        jButton1.setBounds(19, 346, 108, 23);
        ...
        add(jLabel_status);
        jLabel_status.setBounds(0, 346, 15, 24);
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_137.class.getName()).log(Level.SEVERE, null, ex);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                private String NomeClasse()
                {
                    ...
                    String nome =  q_137.class.getName().replaceAll(".java","");
                    nome =  q_137.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
