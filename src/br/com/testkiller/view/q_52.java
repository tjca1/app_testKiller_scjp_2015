 ...
 */
public class q_52 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_52.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_52.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. harrier");

        jRadioButton_b.setText("B. shepherd");
        ...
        jRadioButton_c.setText("C. retriever");
        ...
        jRadioButton_d.setText("D. Compilation fails.");
        ...
        jRadioButton_e.setText("E. retriever harrier");
        ...
        jRadioButton_f.setText("F. An exception is thrown at runtime.");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_52.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                {
                    String nome;
                    nome =  q_52.class.getName().replaceAll(".java","");
                    nome =  q_52.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
