 ...
 */
public class q_18 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_18.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_18.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. public interface B extends A { }");

        jRadioButton_b.setText("B. public interface B implements A {}");

        jRadioButton_c.setText("C. public interface B instanceOf A {}");

        jRadioButton_d.setText("D. public interface B inheritsFrom A { }");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                try
                {
                      internacionalizacao.determinaPropriedadeTextArea1("q_18.textPTA1");
     ...
     public ConteudoTextArea injetaInternacionalizacaoUSA()
    {
                try
                {
                      ...
                      internacionalizacao.determinaPropriedadeTextArea1("q_18.textENA1");
                      conteudo.setS_conteudoTextArea1(internacionalizacao.getConteudoTextArea1());
                      jTextArea1.setText(conteudo.getS_conteudoTextArea1());
