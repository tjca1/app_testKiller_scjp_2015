 ...
 */
public class q_213 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_213.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_213.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_c.setBounds(10, 120, 21, 25);
        ...
        jScrollPane4.setBounds(40, 110, 395, 45);
        ...
        jScrollPane2.setBounds(40, 60, 395, 45);
        ...
        jScrollPane3.setBounds(40, 10, 395, 45);
        ...
        jScrollPane6.setBounds(520, 60, 395, 45);
        ...
        jScrollPane5.setBounds(520, 10, 395, 45);
        ...
        jScrollPane7.setBounds(520, 110, 395, 45);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_b.isSelected() && jRadioButton_d.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_213.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_213.class.getName().replaceAll(".java","");
                    nome =  q_213.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
