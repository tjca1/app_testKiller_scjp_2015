 ...
 */
public class q_58 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_58.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_58.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. 4321");

        jRadioButton_b.setText("B. 0000");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_58.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                {
                    String nome;
                    nome =  q_58.class.getName().replaceAll(".java","");
                    nome =  q_58.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
