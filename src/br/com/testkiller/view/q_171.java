 ...
 */
public class q_171 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_171.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_171.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_c.setBounds(490, 10, 20, 96);
        ...
        jRadioButton_d.setBounds(490, 130, 20, 80);
        ...
        jScrollPane6.setBounds(510, 120, 395, 96);
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_171.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_171.class.getName().replaceAll(".java","");
                    nome =  q_171.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
