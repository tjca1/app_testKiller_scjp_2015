 ...
 */
public class q_120 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_120.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_120.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(10, 11, 938, 332);
        ...
        jScrollPane4.setBounds(40, 150, 395, 60);
        ...
        jScrollPane2.setBounds(40, 80, 395, 60);
        ...
        jScrollPane3.setBounds(40, 10, 395, 60);
        ...
        jRadioButton_c.setBounds(500, 10, 20, 60);
        ...
        jRadioButton_d.setBounds(500, 90, 20, 50);
        ...
        jScrollPane6.setBounds(520, 80, 395, 60);
        ...
        jScrollPane5.setBounds(520, 10, 395, 60);
        ...
        add(jLayeredPane1);
        jLayeredPane1.setBounds(10, 379, 928, 230);
        ...
        add(jButton1);
        jButton1.setBounds(60, 350, 108, 23);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_d.isSelected() && jRadioButton_e.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_120.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_120.class.getName().replaceAll(".java","");
                    nome =  q_120.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
