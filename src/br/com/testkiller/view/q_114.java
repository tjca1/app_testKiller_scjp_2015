 ...
 */
public class q_114 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_114.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_114.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_b.setBounds(20, 110, 21, 96);
        jLayeredPane1.add(jRadioButton_b, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jRadioButton_e.setBounds(20, 210, 21, 96);
        ...
        jScrollPane4.setBounds(50, 210, 395, 100);
        ...
        jScrollPane2.setBounds(50, 110, 395, 96);
        ...
        jRadioButton_d.setBounds(510, 120, 20, 80);
        ...
        jScrollPane6.setBounds(530, 110, 395, 96);
        ...
        jScrollPane7.setBounds(530, 210, 395, 100);
        jLayeredPane1.add(jScrollPane7, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jRadioButton_f.setBounds(510, 210, 21, 100);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_d.isSelected() && jRadioButton_f.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_114.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_114.class.getName().replaceAll(".java","");
                    nome =  q_114.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
