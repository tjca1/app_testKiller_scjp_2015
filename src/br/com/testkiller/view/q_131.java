 ...
 */
public class q_131 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_131.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_131.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 0, 609, 458);
        add(jRadioButton_a);
        ...
        add(jRadioButton_b);
        jRadioButton_b.setBounds(0, 513, 609, 21);
        ...
        add(jRadioButton_c);
        jRadioButton_c.setBounds(0, 534, 609, 21);
        ...
        add(jRadioButton_d);
        jRadioButton_d.setBounds(0, 555, 609, 21);
        ...
        add(jButton1);
        jButton1.setBounds(19, 464, 108, 23);
        ...
        add(jLabel_status);
        jLabel_status.setBounds(0, 464, 15, 24);
        ...
        add(jRadioButton_e);
        jRadioButton_e.setBounds(0, 576, 609, 21);
        ...
        add(jRadioButton_f);
        jRadioButton_f.setBounds(0, 597, 609, 21);
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_131.class.getName()).log(Level.SEVERE, null, ex);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                private String NomeClasse()
                {
                    ...
                    String nome =  q_131.class.getName().replaceAll(".java","");
                    nome =  q_131.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
