 ...
 */
public class q_125 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_125.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_125.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 2, 609, 470);
        add(jRadioButton_a);
        jRadioButton_a.setBounds(0, 504, 535, 23);
        add(jRadioButton_b);
        jRadioButton_b.setBounds(0, 527, 535, 21);
        ...
        add(jRadioButton_c);
        jRadioButton_c.setBounds(0, 548, 535, 21);
        ...
        add(jRadioButton_d);
        jRadioButton_d.setBounds(0, 569, 535, 21);
        ...
        add(jButton1);
        jButton1.setBounds(19, 478, 108, 23);
        ...
        add(jLabel_status);
        jLabel_status.setBounds(0, 478, 15, 24);
        ...
        add(jRadioButton_e);
        jRadioButton_e.setBounds(0, 590, 535, 21);
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_125.class.getName()).log(Level.SEVERE, null, ex);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {
                    String nome;
                    nome =  q_125.class.getName().replaceAll(".java","");
                    nome =  q_125.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
