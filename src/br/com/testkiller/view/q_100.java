 ...
 */
public class q_100 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_100.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_100.status_classe = status_classe;
    }
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_100.class.getName()).log(Level.SEVERE, null, ex);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                {
                    String nome;
                    nome =  q_100.class.getName().replaceAll(".java","");
                    nome =  q_100.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
