 ...
 */
public class q_82 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_82.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_82.status_classe = status_classe;
    }
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_82.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_82.class.getName().replaceAll(".java","");
                    nome =  q_82.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
