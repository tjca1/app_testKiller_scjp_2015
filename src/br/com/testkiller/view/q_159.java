 ...
 */
public class q_159 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_159.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_159.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 6, 938, 50);
        ...
        jTextArea_e.setRows(3);
        jScrollPane4.setViewportView(jTextArea_e);

        jScrollPane4.setBounds(40, 170, 260, 70);
        ...
        jRadioButton_c.setBounds(340, 10, 20, 70);
        ...
        jRadioButton_d.setBounds(340, 100, 20, 50);
        ...
        jRadioButton_f.setBounds(340, 180, 20, 50);
        jLayeredPane1.add(jRadioButton_f, javax.swing.JLayeredPane.DEFAULT_LAYER);

        add(jLayeredPane1);
        jLayeredPane1.setBounds(0, 90, 928, 250);
        ...
        add(jButton1);
        jButton1.setBounds(20, 60, 108, 23);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(verificaOpcaoQestoes == QUANTIDADE_RESPOSTAS)
        {
          if      (  jRadioButton_c.isSelected()
                  && jRadioButton_d.isSelected()
                  && jRadioButton_e.isSelected()
                  && jRadioButton_g.isSelected()
                  )
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_159.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_159.class.getName().replaceAll(".java","");
                    nome =  q_159.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
