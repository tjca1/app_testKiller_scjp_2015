 ...
 */
public class q_95 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_95.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_95.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jSeparator1.setBounds(640, 20, 10, 280);
        ...
        jScrollPane8.setBounds(670, 10, 260, 100);
        ...
        jSeparator2.setBounds(320, 20, 10, 280);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLayeredPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 928, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_b.isSelected() && jRadioButton_c.isSelected() && jRadioButton_d.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_95.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_95.class.getName().replaceAll(".java","");
                    nome =  q_95.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
