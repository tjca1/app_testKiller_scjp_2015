 ...
 */
public class q_42 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_42.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_42.status_classe = status_classe;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_b.isSelected() == true && jRadioButton_c.isSelected() == true && jRadioButton_e.isSelected() == true)
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    String nome;
                    nome =  q_42.class.getName().replaceAll(".java","");
                    nome =  q_42.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
                ...
                {
                    Logger.getLogger(q_42.class.getName()).log(Level.SEVERE, null, ex);
                }
                catch (IOException ex)
                {
                    Logger.getLogger(q_42.class.getName()).log(Level.SEVERE, null, ex);
