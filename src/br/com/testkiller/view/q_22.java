 ...
 */
public class q_22 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_22.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_22.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. double getSalesAmount() { return 1230.45; }");

        jRadioButton_b.setText("B. public double getSalesAmount() { return 1230.45; }");

        jRadioButton_c.setText("C. private double getSalesAmount() { return 1230.45; }");
        ...
        jRadioButton_d.setText("D. protected double getSalesAmount() { return 1230.45; }");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_b.isSelected() == true && jRadioButton_d.isSelected() == true)
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                try
                {
                      internacionalizacao.determinaPropriedadeTextArea1("q_22.textPTA1");
     ...
     public ConteudoTextArea injetaInternacionalizacaoUSA()
    {
                try
                {
                      ...
                      internacionalizacao.determinaPropriedadeTextArea1("q_22.textENA1");
                      conteudo.setS_conteudoTextArea1(internacionalizacao.getConteudoTextArea1());
                      jTextArea1.setText(conteudo.getS_conteudoTextArea1());
