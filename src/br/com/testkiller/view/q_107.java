 ...
 */
public class q_107 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_107.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_107.status_classe = status_classe;
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 820, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_107.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_107.class.getName().replaceAll(".java","");
                    nome =  q_107.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
