 ...
 */
public class q_206 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_206.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_206.status_classe = status_classe;
    }
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_206.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_206.class.getName().replaceAll(".java","");
                    nome =  q_206.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
