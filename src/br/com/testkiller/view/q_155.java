 ...
 */
public class q_155 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_155.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_155.status_classe = status_classe;
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jRadioButton_g, javax.swing.GroupLayout.PREFERRED_SIZE, 535, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(verificaOpcaoQestoes == QUANTIDADE_RESPOSTAS)
        {
           if(
                   ...
                   &&  jRadioButton_c.isSelected()
                   &&  jRadioButton_e.isSelected()
                   &&  jRadioButton_f.isSelected()
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_155.class.getName()).log(Level.SEVERE, null, ex);
                ...
                {
                    String nome;
                    nome =  q_155.class.getName().replaceAll(".java","");
                    nome =  q_155.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
