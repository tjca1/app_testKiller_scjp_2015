 ...
 */
public class q_37 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_37.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_37.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. public void logIt(String * msgs)");

        jRadioButton_b.setText("B. public void logIt(String [] msgs)");

        jRadioButton_c.setText("C. public void logIt(String... msgs)");
        ...
        jRadioButton_d.setText("D. public void logIt(String msg1, String msg2, String msg3)");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                try
                {
                      internacionalizacao.determinaPropriedadeTextArea1("q_37.textPTA1");
     ...
     public ConteudoTextArea injetaInternacionalizacaoUSA()
     {
                try
                {
                      ...
                      internacionalizacao.determinaPropriedadeTextArea1("q_37.textENA1");
                      conteudo.setS_conteudoTextArea1(internacionalizacao.getConteudoTextArea1());
                      jTextArea1.setText(conteudo.getS_conteudoTextArea1());
