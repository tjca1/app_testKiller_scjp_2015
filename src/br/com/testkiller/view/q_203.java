 ...
 */
public class q_203 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_203.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_203.status_classe = status_classe;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_e.isSelected() && jRadioButton_d.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_203.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_203.class.getName().replaceAll(".java","");
                    nome =  q_203.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
