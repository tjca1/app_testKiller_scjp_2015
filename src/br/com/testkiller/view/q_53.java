 ...
 */
public class q_53 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_53.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_53.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. collie");

        jRadioButton_b.setText("B. harrier");
        ...
        jRadioButton_d.setText("D. collie harrier");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_53.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                private String NomeClasse()
                {
                    ...
                    String nome =  q_53.class.getName().replaceAll(".java","");
                    nome =  q_53.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
