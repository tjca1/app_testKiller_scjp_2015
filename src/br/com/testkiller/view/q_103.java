 ...
 */
public class q_103 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_103.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_103.status_classe = status_classe;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_c.isSelected() &&  jRadioButton_f.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_103.class.getName()).log(Level.SEVERE, null, ex);
                ...
                {
                    String nome;
                    nome =  q_103.class.getName().replaceAll(".java","");
                    nome =  q_103.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
