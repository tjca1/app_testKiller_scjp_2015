 ...
 */
public class q_17 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_17.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_17.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. import sun.scjp.Color.*;");

        jRadioButton_b.setText("B. import static sun.scjp.Color.*;");

        jRadioButton_c.setText("C. import sun.scjp.Color; import static sun.scjp.Color.*;");

        jRadioButton_d.setText("D. import sun.scjp.*; import static sun.scjp.Color.*;");
        ...
        jRadioButton_e.setText("E. import sun.scjp.Color; import static sun.scjp.Color.GREEN;");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                try
                {
                      internacionalizacao.determinaPropriedadeTextArea1("q_17.textPTA1");
     ...
     public ConteudoTextArea injetaInternacionalizacaoUSA()
    {
                try
                {
                      ...
                      internacionalizacao.determinaPropriedadeTextArea1("q_17.textENA1");
                      conteudo.setS_conteudoTextArea1(internacionalizacao.getConteudoTextArea1());
                      jTextArea1.setText(conteudo.getS_conteudoTextArea1());
                }
                catch(FileNotFoundException ex)
