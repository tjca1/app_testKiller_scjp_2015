 ...
 */
public class q_150 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_150.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_150.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_d.setBounds(500, 120, 20, 100);
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_150.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_150.class.getName().replaceAll(".java","");
                    nome =  q_150.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
