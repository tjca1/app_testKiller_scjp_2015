 ...
 */
public class q_128 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_128.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_128.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jScrollPane7.setBounds(520, 230, 395, 100);
        ...
        jRadioButton_f.setBounds(500, 240, 20, 90);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_c.isSelected() && jRadioButton_e.isSelected() && jRadioButton_f.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_128.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_128.class.getName().replaceAll(".java","");
                    nome =  q_128.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
