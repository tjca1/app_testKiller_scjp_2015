 ...
 */
public class q_161 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_161.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_161.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 0, 609, 280);
        add(jRadioButton_a);
        jRadioButton_a.setBounds(0, 312, 650, 23);
        ...
        add(jRadioButton_b);
        jRadioButton_b.setBounds(0, 335, 650, 21);
        ...
        add(jRadioButton_c);
        jRadioButton_c.setBounds(0, 356, 650, 21);
        ...
        add(jRadioButton_d);
        jRadioButton_d.setBounds(0, 377, 650, 21);
        ...
        add(jButton1);
        jButton1.setBounds(19, 286, 108, 23);
        ...
        add(jLabel_status);
        jLabel_status.setBounds(0, 286, 15, 24);
        ...
        add(jRadioButton_e);
        jRadioButton_e.setBounds(0, 398, 650, 21);
        ...
        add(jRadioButton_f);
        jRadioButton_f.setBounds(0, 419, 650, 21);
        ...
        add(jRadioButton_g);
        jRadioButton_g.setBounds(0, 440, 650, 21);
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_161.class.getName()).log(Level.SEVERE, null, ex);
                ...
                {
                    String nome;
                    nome =  q_161.class.getName().replaceAll(".java","");
                    nome =  q_161.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
