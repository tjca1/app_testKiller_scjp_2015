 ...
 */
public class q_47 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_47.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_47.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. Point p = Line.getPoint();");

        jRadioButton_b.setText("B. Line.Point p = Line.getPoint();");

        jRadioButton_c.setText("C. Point p = (new Line()).getPoint();");
        ...
        jRadioButton_d.setText("D. Line.Point p = (new Line()).getPoint();");
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_47.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                {
                    String nome;
                    nome =  q_47.class.getName().replaceAll(".java","");
                    nome =  q_47.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
