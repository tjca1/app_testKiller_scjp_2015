 ...
 */
public class q_33 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_33.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_33.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_a.setText("A. Color skyColor = BLUE;");

        jRadioButton_b.setText("B. Color treeColor = Color.GREEN;");

        jRadioButton_c.setText("C. Color purple = new Color( 0xff00ff);");
        ...
        jRadioButton_d.setText("D. if( RED.getRGB() < BLUE.getRGB() ) {}");
        ...
        jRadioButton_e.setText("E. Color purple = Color.BLUE + Color.RED;");
        ...
        jRadioButton_f.setText("F. if( Color.RED.ordinal() < Color.BLUE.ordinal() ) {}");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jRadioButton_c, javax.swing.GroupLayout.DEFAULT_SIZE, 595, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_b.isSelected() == true && jRadioButton_f.isSelected() == true)
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                try
                {
                      internacionalizacao.determinaPropriedadeTextArea1("q_33.textPTA1");
     ...
     public ConteudoTextArea injetaInternacionalizacaoUSA()
    {
                try
                {
                      ...
                      internacionalizacao.determinaPropriedadeTextArea1("q_33.textENA1");
                      conteudo.setS_conteudoTextArea1(internacionalizacao.getConteudoTextArea1());
                      jTextArea1.setText(conteudo.getS_conteudoTextArea1());
