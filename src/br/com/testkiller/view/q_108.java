 ...
 */
public class q_108 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_108.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_108.status_classe = status_classe;
    }
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_108.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_108.class.getName().replaceAll(".java","");
                    nome =  q_108.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
