 ...
 */
public class q_148 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_148.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_148.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(0, 16, 938, 80);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
          if(jRadioButton_b.isSelected() && jRadioButton_e.isSelected() && jRadioButton_f.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_148.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_148.class.getName().replaceAll(".java","");
                    nome =  q_148.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
