 ...
 */
public class q_202 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_202.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_202.status_classe = status_classe;
    }
    ...
    private void initComponents() {
        ...
        jRadioButton_e.setBounds(490, 20, 20, 25);
        ...
        jRadioButton_d.setBounds(490, 70, 20, 25);
        ...
        jScrollPane5.setViewportView(jTextArea_e);
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_202.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_202.class.getName().replaceAll(".java","");
                    nome =  q_202.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
