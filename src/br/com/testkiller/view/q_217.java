 ...
 */
public class q_217 extends javax.swing.JPanel {
 ...
 private ConteudoTextArea conteudo = new ConteudoTextArea();
    ...
    public static void setStatus_questao(String status_questao) {
        q_217.status_questao = status_questao;
    }
   ...
   public static boolean isStatus_classe()
    ...
    {
        q_217.status_classe = status_classe;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
           if(jRadioButton_b.isSelected() && jRadioButton_c.isSelected())
            {
    ...
    public ConteudoTextArea injetaInternacionalizacao()
    {
                ...
                {
                    Logger.getLogger(q_217.class.getName()).log(Level.SEVERE, null, ex);
              ...
              private String NomeClasse()
                {
                    String nome;
                    nome =  q_217.class.getName().replaceAll(".java","");
                    nome =  q_217.class.getName().replaceAll("br.com.testkiller.view.","");
                    return nome;
                }
